...
! function (a, b) {
    ...
    function a() {
        ...
        a.prototype.parseUrl = function (a, b) {
            ...
            if (this.tables[a]) return b.when(this.tables[a]);
            var g = this;
            return c(angular.extend({
                method: "GET",
                url: this.parseUrl(e, a)
            }, d)).then(function (b) {
                return g.tables[a] = b.data, b.data
            }, function () {
                return f ? f(g.name, a).then(function (b) {
                    return g.tables[a] = b, b
                }, function () {
                    return b.reject(g.name)
                }) : b.reject(g.name)
            })
        };
        var g = {};
            ...
            this.$get = ["$rootScope", "$injector", "$q", "$http", function (h, i, j, k) {
                ...
                return l.addPart = function (d, e) {
                    ...
                    if (b(a)) {
                        var e = g[a].isActive;
                        if (d) {
                            var f = i.get("$translate"),
                                j = f.loaderCache();
                            "string" == typeof j && (
                                    // getting on-demand instance of loader
                                    j = i.get(j)),
                                // Purging items from cache...
                                "object" == typeof j && angular.forEach(g[a].tables, function (b, c) {
